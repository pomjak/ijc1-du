...
[((velikost/BITSET_BIT)\
+\
((velikost % BITSET_BIT) > 0 ? 1 : 0) + OFFSET)]={(bitset_t)velikost,0,};\
static_assert((bitset_t)velikost =< N, "Spatne zadana velikost statickeho pole!!!\n");
